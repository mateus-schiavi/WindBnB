...
const TableCard = ({
            ...
            <div className="nav-menu">
                <div className="text">
                    <div className="search-items">
                        <button
                            className={`left-search search nav-btn left ${list1Open ? "active" : ""
                                }`}
                ...
                ${windowWidth >= 700 && list2Open
                    ...
                    >
                        ...
                        <div
                            className={` ${list2Open ? "guest-container-actived" : "guest-container"
                                }`}
                        >
                            {list2Open && (
    ...
    TableCard.propTypes = {
        ...
        adultGuests: PropTypes.number.isRequired,
        childrenGuests: PropTypes.number.isRequired,
